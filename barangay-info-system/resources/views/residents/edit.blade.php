...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="mb-1">Edit Resident Profile</h2>
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="date" name="birthdate" class="form-control" value="{{ old('birthdate', $resident->birthdate->format('Y-m-d')) }}" required>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Place of Birth</label>
                        <input type="text" name="place_of_birth" class="form-control" value="{{ old('place_of_birth', $resident->place_of_birth) }}" placeholder="City/Municipality, Province">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Gender</label>
                        <select name="gender" class="form-select" required>
                            @foreach(['Male', 'Female', 'Other'] as $gender)
                                <option value="{{ $gender }}" {{ old('gender', $resident->gender) == $gender ? 'selected' : '' }}>{{ $gender }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Citizenship</label>
                        <input type="text" name="citizenship" class="form-control" value="{{ old('citizenship', $resident->citizenship ?? 'Filipino') }}" required>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="educational_attainment" class="form-select">
                            ...
                            @foreach(['No Formal Education', 'Elementary Level', 'Elementary Graduate', 'High School Level', 'High School Graduate', 'Senior High School Graduate', 'Vocational', 'College Level', 'College Graduate', 'Post Graduate'] as $level)
                                <option value="{{ $level }}" {{ old('educational_attainment', $resident->educational_attainment) == $level ? 'selected' : '' }}>{{ $level }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="relationship_to_household_head" class="form-select">
                            ...
                            @foreach(['Head', 'Spouse', 'Child', 'Parent', 'Sibling', 'Grandchild', 'Relative', 'Boarder', 'Helper', 'Other'] as $relationship)
                                <option value="{{ $relationship }}" {{ old('relationship_to_household_head', $resident->relationship_to_household_head) == $relationship ? 'selected' : '' }}>{{ $relationship }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Date of Residency</label>
                        <input type="date" name="date_of_residency" class="form-control" value="{{ old('date_of_residency', optional($resident->date_of_residency)->format('Y-m-d')) }}">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        <div class="form-check form-switch mt-2">
                            ...
                            <input class="form-check-input" type="checkbox" name="is_registered_voter" value="1" id="isRegisteredVoter" {{ old('is_registered_voter', $resident->is_registered_voter) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="voter_precinct_number" class="form-control" value="{{ old('voter_precinct_number', $resident->voter_precinct_number) }}" placeholder="e.g. 0123A">
                    </div>
                    <div class="col-md-4">
                        <div class="form-check form-switch mt-4">
                            <input type="hidden" name="is_senior_citizen" value="0">
                            <input class="form-check-input" type="checkbox" name="is_senior_citizen" value="1" id="isSeniorCitizen" {{ old('is_senior_citizen', $resident->is_senior_citizen) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-4">
                        <div class="form-check form-switch mt-4">
                            ...
                            <input class="form-check-input" type="checkbox" name="is_pwd" value="1" id="isPwd" {{ old('is_pwd', $resident->is_pwd) ? 'checked' : '' }}>
                            <label class="form-check-label" for="isPwd">Person with disability</label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">PWD ID Number</label>
                        <input type="text" name="pwd_id_number" class="form-control" value="{{ old('pwd_id_number', $resident->pwd_id_number) }}">
                    </div>
                    <div class="col-md-4">
                        <div class="form-check form-switch mt-4">
                            <input type="hidden" name="is_solo_parent" value="0">
                            <input class="form-check-input" type="checkbox" name="is_solo_parent" value="1" id="isSoloParent" {{ old('is_solo_parent', $resident->is_solo_parent) ? 'checked' : '' }}>
                            <label class="form-check-label" for="isSoloParent">Solo parent</label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Solo Parent ID Number</label>
                        <input type="text" name="solo_parent_id_number" class="form-control" value="{{ old('solo_parent_id_number', $resident->solo_parent_id_number) }}">
                    </div>
                    <div class="col-md-4">
                        <div class="form-check form-switch mt-4">
                            <input type="hidden" name="is_4ps_beneficiary" value="0">
                            <input class="form-check-input" type="checkbox" name="is_4ps_beneficiary" value="1" id="is4psBeneficiary" {{ old('is_4ps_beneficiary', $resident->is_4ps_beneficiary) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-4">
                        <div class="form-check form-switch mt-4">
                            ...
                            <input class="form-check-input" type="checkbox" name="is_indigenous_person" value="1" id="isIndigenousPerson" {{ old('is_indigenous_person', $resident->is_indigenous_person) ? 'checked' : '' }}>
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="philhealth_id" class="form-control" value="{{ old('philhealth_id', $resident->philhealth_id) }}">
                    </div>
                    <div class="col-md-4">
                        <div class="form-check form-switch mt-4">
                            <input type="hidden" name="is_active" value="0">
                            <input class="form-check-input" type="checkbox" name="is_active" value="1" id="isActive" {{ old('is_active', $resident->is_active) ? 'checked' : '' }}>
                            <label class="form-check-label" for="isActive">Active resident</label>
                        </div>
                    </div>
                </div>
            </div>
